...
% scale_response = ifft(resizeDFT(scale_responsef,param.nScales),'symmetric');
   ...
   % currentScaleFactor=model.currentScaleFactor * param.scaleSizeFactors(recovered_scale_index);
